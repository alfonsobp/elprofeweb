...
@section('horizontal_links')
	<a id="nav_right" href="filtros" data-transition="slide"></a>
	<a id="nav_left" href="categorias" data-transition="slide" data-direction="reverse"></a>
@stop
...
@section('page')
	...
	{{HTML::script("js/middle/subjects.js")}}
	{{HTML::style("css/middle/subjects.css")}}
@stop